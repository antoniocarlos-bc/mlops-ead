...
def config_mlflow():
    ...
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'antoniocarlos-bc'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = '0fbdb3db57a57141fc0141e870abfb76d56203db'
    mlflow.set_tracking_uri('https://dagshub.com/antoniocarlos-bc/mlops-ead.mlflow')
